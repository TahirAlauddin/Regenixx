...
"}")
        ...
        self.scrollAreaWidgetContents.setGeometry(QRect(0, 0, 65, 64))
...
"margin-left: 10px;")
    ...
    def retranslateUi(self, MainPages):
        ...
        self.goBackToPatientstPageButton.setText(QCoreApplication.translate("MainPages", u"Patients", None))
        self.logo_2.setText("")
